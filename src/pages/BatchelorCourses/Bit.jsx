...
const Csit = () => {
    ...
    const courseCategories = [
        {
            id: 'B.IT',
            title: 'Hello Programmers... Welcome to B.IT',
            courses: [
                {
                    id: '1',
                    title: 'B.IT First Semister',
    ...
    return (
        <>
            <Navbar />
            <PageHeader title="Batchelor in Information Technology" path="/bit" name="B.IT" />
