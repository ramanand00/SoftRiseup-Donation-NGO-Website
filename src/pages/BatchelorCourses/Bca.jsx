...
const Csit = () => {
    ...
    const courseCategories = [
        {
            id: 'BCA',
            title: 'Hello Codders... Welcome to BCA',
            courses: [
                {
                    id: '1',
                    title: 'BCA First Semister',
    ...
    return (
        <>
            <Navbar />
            <PageHeader title="Batchelor of Computer Application" path="/bca" name="BCA" />
